...
public class TrainOrderDetailActivity extends BaseActivity implements ViewManager_trainOrderDetail, View.OnClickListener {
    ...
    private View item_costCenter, item_project, item_weiItem, item_weiReason, item_approveinfo,
            item_payinfo, item_approveState, item_approve_chose, item_applyNo;
    ...
    protected void findViews() {
        ...
        commit = (TextView) findViewById(R.id.train_order_detail_commit);
        cancle = (TextView) findViewById(R.id.train_order_detail_cancle);
        ...
        item_payinfo = findViewById(R.id.train_order_detail_payinfo);
...
//            applyNo.setFocusable(false);
    ...
    public void setVisibility(TrainOrderDetailBean b) {
        ...
        if (pTrainOrderDetail.getmOrderStatus() == STATUS_DAICHUPIAO) {
            item_payinfo.setVisibility(View.VISIBLE);
            TextView price = (TextView) findViewById(R.id.train_order_detail_priceall2);
            price.setText("￥" + AppUtils.keepTwoSecimal2(b.getTotalprice() + ""));
        } else {
            item_payinfo.setVisibility(View.GONE);
        }
        ///////////////////////////////////////
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.train_order_detail_commit:
                ...
                break;
            case R.id.train_order_detail_cancle:
