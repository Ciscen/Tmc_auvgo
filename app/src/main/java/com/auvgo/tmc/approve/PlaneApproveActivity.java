...
public class PlaneApproveActivity extends BaseActivity implements View.OnClickListener, ViewManager_PlaneOrderDetail {
    ...
    private View approveInfo_vg, approveStatus_vg, priceDetail_vg, payInfo_vg;
    ...
    protected void findViews() {
        ...
        payInfo_vg = findViewById(R.id.plane_order_detail_payinfo);
    }

    @Override
    protected void initView() {
        payInfo_vg.setVisibility(View.GONE);
